// Compilation : antlr4 Rationnel.g4             Execution : javac Rationnel*.java

// --- To run the parser on an input file --- grun Rationnel start -tree

//--- To run the parser and show tokens --- grun Rationnel start -tokens

// --- To run the parser with a GUI parse tree viewer --- grun Rationnel start -gui

// --- To generate MVaP code --- grun Rationnel start < input.txt > out.mvap
...
// ---------------- Parser rules ----------------
start: (
		(SEMICOLON | NEWLINE)* instruction (SEMICOLON | NEWLINE)*
	)* EOF {
      StringBuilder prog = new StringBuilder();
      prog.append("ALLOC 13\n\n");
